    ...
    <div className="min-h-screen bg-white text-neutral-900">
      ...
      <section className="bg-amber-50/40">
        <div className="max-w-6xl mx-auto px-6 py-16">
          <h1 className="text-3xl md:text-5xl font-semibold text-neutral-900">Our Projects</h1>
          <p className="mt-3 text-neutral-600 max-w-2xl">Explore recent renovations that blend clean lines, natural textures, and warm light.</p>
        </div>
      </section>
      ...
      <section className="bg-white">
        <div className="max-w-6xl mx-auto px-6 pb-16">
          <div className="rounded-xl border border-neutral-200 p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              <h3 className="text-xl font-semibold text-neutral-900">Like what you see?</h3>
              <p className="text-neutral-600">We can recreate these looks or tailor something uniquely yours.</p>
            </div>
            <a href="/#contact" className="inline-flex rounded-md bg-amber-600 hover:bg-amber-700 text-white px-4 py-2">Start Your Project</a>
          </div>
        </div>
      </section>
